...
public class CardVisual : MonoBehaviour
{
    ...
    private CardContentsLoader cardContentsLoader;
    [SerializeField] private Transform shakeParent;
    [SerializeField] private Transform tiltParent;
    [SerializeField] private Image cardContainer;
    ...
    public void Initialize(Card target, string itemName, int index = 0)
    {
        //Declarations
        parentCard = target;
        ...
        cardContentsLoader = cardContainer.GetComponent<CardContentsLoader>();
        ...
        //Load Card Image and Name Text
        cardContentsLoader.LoadItemCardContents(itemName);
